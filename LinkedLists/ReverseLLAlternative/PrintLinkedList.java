package LinkedLists.ReverseLLAlternative;
...
public class PrintLinkedList {
    ...
    public static Node<Integer> reverseLL(Node<Integer> head){
        ...
        Node<Integer> reversedTail = head.next; // jdo reverse ho k aai list, odo last element(i.e tail) initial list ch head to next element hoyega always. 
        // i.e acc to line 54, 2 3 4 will be 4 3 2, here 2 is head.next in initial list
